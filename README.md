...
$app_factory->registration_middleware( PinkCrab\WP_Rest_Schema\Utils::middleware_provider() );
```
...
> @return \PinkCrab\WP_Rest_Schema\Route\Route
...
> @param PinkCrab\WP_Rest_Schema\Route\Argument $argument  
> @return \PinkCrab\WP_Rest_Schema\Route\Route
...
> @param callable $callback  
> @return \PinkCrab\WP_Rest_Schema\Route\Route_Group  
